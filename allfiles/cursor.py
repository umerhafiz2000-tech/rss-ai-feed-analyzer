...
DATABASE_NAME = '1cyber_security_feeds'
COLLECTION_NAME = 'feed_entries'
...
class RSSAggregator:
    def __init__(self):
        ...
        self.collection.create_index("feed_url")
        ...
        for entry in feed_data['entries']:
            try:
                ...
                if existing_entry:
                    ...
                    if existing_entry.get('content_hash') != entry['content_hash']:
    ...
    def get_database_stats(self) -> Dict:
        ...
        try:
            ...
            unique_feeds = len(self.collection.distinct('feed_url'))
            ...
            recent_entries = self.collection.count_documents({'last_updated': {'$gte': yesterday}})
    ...
    def cleanup_old_entries(self, days_old: int = 30):
        ...
        try:
            ...
            logger.info(f"Cleaned up {result.deleted_count} entries older than {days_old} days")
...
class DatabaseManager:
    ...
    def show_stats(self):
        ...
        try:
            ...
            # Entries by feed
            feed_counts = list(self.collection.aggregate([
            ...
            print("\nTop 10 feeds by entry count:")
            for feed in feed_counts:
                print(f"  {feed['count']:4d} entries - {feed['_id']}")
